            ...
            return {
                    ...
                    "members": [
                            ...
                            },
                            {
                                    ...
                                    "type": "String",
                                    "desc":
                                    "Synthesis tool to use (lse or synplify)",
                            },
                    ],
            }
...
"""
        ...
        with open(
                os.path.join(self.work_root, self.name + "_run.tcl"), "w"
        ) as f:
            f.write(
